...
function foo(bar) {
	...
	function buildSettingsDialog() {
		...
		body.append(widthRow.row, fontSizeRow.row, fontFamilyRow.row, fontQuickRow, lineHeightRow.row, paraSpacingRow.row);
		syncFontQuick();
